...
export default class NavigationBar extends Component {
  render() {
    ...
    if (
      ...
      this.props.location.pathname.startsWith("/employee-portal/computers/")
    ) {
      text = "Add a Computer";
    } else if (
      this.props.location.pathname.startsWith("/employee-portal/departments/")
    ) {
      text = "Add a Department";
    } else if (
      this.props.location.pathname.startsWith("/employee-portal/training/")
    ) {
      text = "Add Trainings";
    } else if (
      this.props.location.pathname.startsWith("/customer-portal/products/")
    ) {
      text = "Add a Product";
    } else if (
      this.props.location.pathname.startsWith("/customer-portal/orders/")
    ) {
      text = "Add an Order";
    }
        ...
        <>
          {this.props.view === "Employees" ? (
            <div className="portalDiv">
              <h4 className="viewManager">
                {this.props.view.toUpperCase()} MANAGER
              </h4>
              <div className="portalButton">
                <Link to="/customer-portal/">
                  <Button color="facebook">Go to Customer Portal</Button>
                </Link>
              </div>
            </div>
          ) : (
      ...
      return (
        <>
          ...
          {this.props.location.pathname === "/employee-portal/" ? (
            <div className="barAndButtonContainer">
              <Header as="h3" className="viewHeader">
                Employees
              </Header>
              <div className="searchBarContainer">
                <Route
