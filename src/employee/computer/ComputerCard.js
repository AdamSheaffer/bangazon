...
export default class ComputerCard extends Component {
  ...
  render() {
    ...
    if (!this.props.computer.decomissionDate) {
      status = "Active";
        ...
        <Table celled>
          ...
          <Table.Body>
            <Table.Row>
              ...
              <Table.Cell>
                {this.props.computer.make} {this.props.computer.model}
              </Table.Cell>
              <Table.Cell>
                {moment(this.props.computer.purchaseDate).format("MM/DD/YYYY")}
              </Table.Cell>
